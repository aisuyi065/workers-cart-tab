...
color:#436EEE;
    ...
    .card {
        background-color: rgba(228, 219, 240, 0.6) !important;
        border-radius: 5px;
        padding: 10px; /* 进一步减小卡片内边距6 */
        width: 182px;
...
@media (max-width: 480px) {
    .card {
        width: 368px; /* 手机上显示4列，235时显示6列 */
        padding: 24px; /* 进一步减小卡片内边距6 */
    }
    .card-icon {
        width: 48px;
        height: 52px;
...
<body class="background">
    <div class="fixed-elements">
        ...
        <div class="sites">
        <h1 class="title"><a href="https://xiaoke.name/">小可の主页</a></h1><div>
    ...
    <div class="content">
        ...
        <!-- 分类和卡片容器 -->
        <div class="sites1"><div id="sections-container" class="head"></div></div>
        <!-- 主题切换按钮 -->
